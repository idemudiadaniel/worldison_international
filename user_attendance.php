...
if (!isset($_SESSION['role']) || !in_array($_SESSION['role'], ['admin','accountant','ceo','manager','staff','editor'])) {
  header("Location: dashboard.php");
  exit;
}

$staff_id = $_SESSION['staff_id']; // staff_id stored in session when user logs in
...
<?php include("inc/head.php"); ?>
  ...
  <h3 class="mb-4">My Attendance History</h3>
...
<!-- ✅ JS Scripts (Cleaned for Live Deployment) -->
